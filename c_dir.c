...
/**
 * cd_to - to change the directory as inputed
 * by the user
 * @datash: the directories data
 * Return: no return
 */
...
/**
 * cd_prev - to change to the previous directory
 * @datash: the previous directory data
 * Return: no return
 */
...
void cd_prev(data_myshell *datash)
{
	...
	p_oldpwd = _getenv("OLDPWD", datash->my_environ);
	...
	p_pwd = _getenv("PWD", datash->my_environ);
...
void cd_home(data_myshell *datash)
{
	...
	home = _getenv("HOME", datash->my_environ);
